...
public class TSDBlockProps {
    ...
    public static final BlockBehaviour.Properties SCULK_SPINE = BlockBehaviour.Properties.of(Material.SCULK, MaterialColor.COLOR_BLACK).strength(0.4F).sound(SoundType.SCULK_SHRIEKER);
