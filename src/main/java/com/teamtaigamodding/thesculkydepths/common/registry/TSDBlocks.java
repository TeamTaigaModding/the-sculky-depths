...
public class TSDBlocks {
    ...
    public static final RegistryObject<Block> SCULK_CARTILAGE = HELPER.createBlock("sculk_cartilage", () -> new RotatedPillarBlock(TSDBlockProps.SCULK_CARTILAGE), CreativeModeTab.TAB_BUILDING_BLOCKS);
    ...
    public static final RegistryObject<Block> SCULK_VERTEBRAE = HELPER.createBlock("sculk_vertebrae", () -> new SculkVertebraeBlock(TSDBlockProps.SCULK_VERTEBRAE), CreativeModeTab.TAB_BUILDING_BLOCKS);
