...
public class TSDBlocks {
    ...
    public static final RegistryObject<Block> STONE_CHEST = HELPER.createBlock("stone_chest", () -> new StoneChestBlock(BlockProperties.STONE_CHEST), CreativeModeTab.TAB_DECORATIONS);
